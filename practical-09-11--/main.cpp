...
//    1         set faciliies-------2 table tennis and 2 treadmills
//    2         invite costomers-----Karen Liu Zhang Hao with id 1 2 3 4 respectively
...
{   
    ...
    for (int i=0;i<4;i++){
        cout<<Vip_names[i]<<", do you want to play table_tennis or treadmill （type your prefer): ";
        string choice;
        cin>>choice;
        
        switch (choice){
            case "table_tennis:   //choose table tennis
            if (Tennis_index==2){
            ...
            Tennis_index++;
            break;
            case "treadmill":   //choose Treadmill
