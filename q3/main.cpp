...
int main(){
	...
	Asset* my_things[len];
       ...
       // (1)fill the assets up with 2 pens and two laptops (different values for each)
        my_things[0]=new Pen(1);
       my_things[1]=new Pen(2);
       my_things[2]=new Laptop(3);
       my_things[3]=new Laptop(4);
       // (2)calculate the total value of all assets in my_things and print it out
        int value=my_things[0]-> get_value()+my_things[1]-> get_value()+my_things[2]-> get_value()+my_things[3]-> get_value();
        cout<<value<<endl;
